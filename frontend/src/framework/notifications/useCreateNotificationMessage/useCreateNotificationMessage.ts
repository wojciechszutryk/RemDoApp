...
import { ITodoListNotificationMessage } from "./notificationMessage.model";

const useCreateTodoListNotificationMessage = () => {
...
export default useCreateTodoListNotificationMessage;
