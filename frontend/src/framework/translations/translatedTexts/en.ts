...
export const enTranslation: Record<TranslationKeys, string> = {
  ...
  [TranslationKeys.NumberMustBePositive]: "* Value must be positive",
  ...
  [TranslationKeys.NoDate]:
    "No Start or finish date specified. Set it in 'Date' panel",

  [TranslationKeys.Reccurance]: "Reccurance",
  [TranslationKeys.First]: "First",
  [TranslationKeys.Second]: "Second",
  [TranslationKeys.Third]: "Third",
  [TranslationKeys.Fourth]: "Fourth",
  ...
  [TranslationKeys.WeekendDays]: "Weekend days",
  [TranslationKeys.Weekdays]: "Weekdays",
  [TranslationKeys.January]: "January",
  [TranslationKeys.February]: "February",
  [TranslationKeys.March]: "March",
  [TranslationKeys.April]: "April",
  [TranslationKeys.May]: "May",
  [TranslationKeys.June]: "June",
  [TranslationKeys.July]: "July",
  [TranslationKeys.August]: "August",
  [TranslationKeys.September]: "September",
  [TranslationKeys.October]: "October",
  [TranslationKeys.November]: "November",
  [TranslationKeys.December]: "December",
  [TranslationKeys.Daily]: "Daily",
  [TranslationKeys.Weekly]: "Weekly",
  [TranslationKeys.Monthly]: "Monthly",
  [TranslationKeys.Yearly]: "Yearly",
  [TranslationKeys.DayOfTheMonth]: "Day of the month",
  [TranslationKeys.WeekDay]: "Week day",
  [TranslationKeys.WeekDayOfMonths]: "Week days of months",
  [TranslationKeys.Every]: "Every",
  [TranslationKeys.Weeks]: "Week(s)",
  [TranslationKeys.Months]: "Month(s)",
  [TranslationKeys.Years]: "Year(s)",
  [TranslationKeys.On]: "On the day of the month",
  [TranslationKeys.OnThe]: "On the",
  [TranslationKeys.Of]: "Of",
  [TranslationKeys.EndType]: "End type",
  [TranslationKeys.EndByDate]: "End by date",
  [TranslationKeys.EndAfter]: "End after",
  [TranslationKeys.EndNever]: "End never",
  [TranslationKeys.AfterOccurances]: "After occurances",
